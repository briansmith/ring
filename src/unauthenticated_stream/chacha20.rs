...
use crate::{chacha, error, polyfill, unauthenticated_stream};
...
pub static CHACHA20: unauthenticated_stream::Algorithm =
                                        unauthenticated_stream::Algorithm {
    key_len: chacha::KEY_LEN_IN_BYTES,
    init: chacha20_init,
    xor_keystream: chacha20_xor_keystream,
    id: unauthenticated_stream::AlgorithmID::CHACHA20,
...
fn chacha20_xor_keystream(ctx: &[u64; unauthenticated_stream::KEY_CTX_BUF_ELEMS],
                          nonce: &[u8; unauthenticated_stream::NONCE_LEN],
...
fn ctx_as_key(ctx: &[u64; unauthenticated_stream::KEY_CTX_BUF_ELEMS])
...
#[inline]
fn make_counter(nonce: &[u8; unauthenticated_stream::NONCE_LEN]) -> chacha::Counter {
