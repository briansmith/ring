...
///
/// This is intended for implementation by *ring*-internal traits only. It is
/// used to abstract over the differences in number/size of parameters
/// between different signature algorithms.
