...
use super::super::super::{
    limbs512::storage::{as_const_uninit, check_common, check_common_with_n},
    n0::N0,
...
pub(in super::super::super) fn gather5(
    ...
    let num_limbs = check_common(r, as_const_uninit(table))?;
...
pub(in super::super::super) fn power5_amm(
    ...
    let num_limbs = check_common_with_n(in_out, as_const_uninit(table), n)?;
