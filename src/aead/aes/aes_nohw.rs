...
use super::{super::overlapping::IndexError, Counter, Overlapping, AES_KEY, BLOCK_LEN, MAX_ROUNDS};
...
pub(super) fn ctr32_encrypt_within(key: &AES_KEY, mut in_out: Overlapping, ctr: &mut Counter) {
