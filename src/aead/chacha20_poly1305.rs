...
fn chacha20_poly1305_seal(
    ...
    if has_integrated(cpu_features) {
        ...
        let mut data = chacha20_poly1305_c::InOut {
            input: seal_data_in {
        ...
        prefixed_extern! {
            fn chacha20_poly1305_seal(
                ...
                ad: *const u8,
                ad_len: usize,
                data: &mut chacha20_poly1305_c::InOut<seal_data_in>,
            );
        }
    ...
    if has_integrated(cpu_features) {
        ...
        prefixed_extern! {
            fn chacha20_poly1305_open(
                ...
                ad: *const u8,
                ad_len: usize,
                data: &mut chacha20_poly1305_c::InOut<open_data_in>,
            );
        }
