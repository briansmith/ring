...
pub static COMMON_OPS: CommonOps = CommonOps {
    ...
    elem_add_impl: RingCore_p384_elem_add,
    elem_mul_mont: RingCore_p384_elem_mul_mont,
    elem_sqr_mont: RingCore_p384_elem_sqr_mont,

    point_add_jacobian_impl: RingCore_nistz384_point_add,
};
...
pub static PRIVATE_KEY_OPS: PrivateKeyOps = PrivateKeyOps {
    ...
    point_mul_impl: RingCore_nistz384_point_mul,
};
...
pub static SCALAR_OPS: ScalarOps = ScalarOps {
    ...
    scalar_mul_mont: RingCore_p384_scalar_mul_mont,
};
...
fn p384_scalar_inv_to_mont(a: &Scalar<Unencoded>) -> Scalar<R> {
    ...
    fn mul(a: &Scalar<R>, b: &Scalar<R>) -> Scalar<R> {
        binary_op(RingCore_p384_scalar_mul_mont, a, b)
    }

    fn sqr(a: &Scalar<R>) -> Scalar<R> { binary_op(RingCore_p384_scalar_mul_mont, a, a) }

    fn sqr_mut(a: &mut Scalar<R>) {
        unary_op_from_binary_op_assign(RingCore_p384_scalar_mul_mont, a);
    }
    ...
    fn sqr_mul_acc(acc: &mut Scalar<R>, squarings: usize, b: &Scalar<R>) {
        ...
        binary_op_assign(RingCore_p384_scalar_mul_mont, acc, b)
    }
    ...
    fn to_mont(a: &Scalar<Unencoded>) -> Scalar<R> {
        ...
        binary_op(RingCore_p384_scalar_mul_mont, a, &N_RR)
    }
...
unsafe extern "C" fn RingCore_p384_elem_sqr_mont(
    r: *mut Limb,   // [COMMON_OPS.num_limbs]
    a: *const Limb, // [COMMON_OPS.num_limbs]
) {
    // XXX: Inefficient. TODO: Make a dedicated squaring routine.
    RingCore_p384_elem_mul_mont(r, a, a);
}
...
extern "C" {
    fn RingCore_p384_elem_add(
        r: *mut Limb,   // [COMMON_OPS.num_limbs]
        a: *const Limb, // [COMMON_OPS.num_limbs]
        b: *const Limb, // [COMMON_OPS.num_limbs]
    );
    fn RingCore_p384_elem_mul_mont(
        r: *mut Limb,   // [COMMON_OPS.num_limbs]
        a: *const Limb, // [COMMON_OPS.num_limbs]
        b: *const Limb, // [COMMON_OPS.num_limbs]
    );

    fn RingCore_nistz384_point_add(
        r: *mut Limb,   // [3][COMMON_OPS.num_limbs]
        a: *const Limb, // [3][COMMON_OPS.num_limbs]
        b: *const Limb, // [3][COMMON_OPS.num_limbs]
    );
    fn RingCore_nistz384_point_mul(
        r: *mut Limb,          // [3][COMMON_OPS.num_limbs]
    ...
    fn RingCore_p384_scalar_mul_mont(
        r: *mut Limb,   // [COMMON_OPS.num_limbs]
        a: *const Limb, // [COMMON_OPS.num_limbs]
        b: *const Limb, // [COMMON_OPS.num_limbs]
    );
