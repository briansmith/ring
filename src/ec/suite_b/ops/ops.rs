...
impl CommonOps {
    ...
    pub fn elem_verify_is_not_zero(&self, a: &Elem) -> err::EmptyResult {
        match unsafe {
...
pub struct PrivateKeyOps {
    ...
    point_mul_base_impl: fn(a: &Scalar) -> err::Result<Point>,
...
impl PrivateKeyOps {
    #[inline(always)]
    pub fn point_mul_base(&self, a: &Scalar) -> err::Result<Point> {
