...
const RING_SRCS: &[(&[&str], &str)] = &[
    ...
    (&[PPC], "crypto/chacha/asm/chacha-ppc.pl"),
    (&[PPC], "crypto/poly1305/asm/poly1305-ppc.pl"),
    (&[PPC], "crypto/poly1305/asm/poly1305-ppcfp.pl"),
    (&[PPC], "crypto/fipsmodule/aes/asm/aes-ppc.pl"),
    (&[PPC], "crypto/fipsmodule/aes/asm/aesp8-ppc.pl"),
    ...
    (&[PPC64], "crypto/fipsmodule/ec/asm/x25519-ppc64.pl"),
