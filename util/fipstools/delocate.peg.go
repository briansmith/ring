	...
	_rules = [...]func() bool{
		...
		func() bool {
			...
			l441:
				...
				position++
				add(ruleBaseIndexScale, position435)
			}
			return true
		l434:
		...
		func() bool {
			...
			l499:
				...
				position++
				add(ruleSegmentRegister, position498)
			}
			return true
		l497:
