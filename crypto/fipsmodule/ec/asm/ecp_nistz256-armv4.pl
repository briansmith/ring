...
@ void	RingCore_nistz256_add(BN_ULONG r0[8],const BN_ULONG r1[8],
@					const BN_ULONG r2[8]);
...
@ void	RingCore_nistz256_neg(BN_ULONG r0[8],const BN_ULONG r1[8]);
...
$code.=<<___;
@ void	RingCore_nistz256_mul_mont(BN_ULONG r0[8],const BN_ULONG r1[8],
@					     const BN_ULONG r2[8]);
