...
$code.=<<___;
	...
	.long		0
.size	.GFp_gcm_init_p8,.-.GFp_gcm_init_p8
___
}
$code.=<<___;
.globl	.GFp_gcm_gmult_p8
.align	5
.GFp_gcm_gmult_p8:
	lis		r0,0xfff8
	li		r8,0x10
	...
	.byte		0,12,0x14,0,0,0,2,0
	.long		0
.size	.GFp_gcm_gmult_p8,.-.GFp_gcm_gmult_p8

.globl	.GFp_gcm_ghash_p8
.align	5
.GFp_gcm_ghash_p8:
	li		r0,-4096
	li		r8,0x10
...
$code.=<<___;
.size	.GFp_gcm_ghash_p8,.-.GFp_gcm_ghash_p8
