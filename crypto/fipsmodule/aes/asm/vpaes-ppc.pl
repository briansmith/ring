...
Ldec_done:
	...
	.byte	0,12,0x04,1,0x80,0,3,0
	.long	0
.size	.GFp_vpaes_decrypt,.-.GFp_vpaes_decrypt

.globl	.GFp_vpaes_cbc_encrypt
.align	5
.GFp_vpaes_cbc_encrypt:
	${UCMP}i r5,16
	bltlr-
...
Lcbc_abort:
	...
	.long	0
.size	.GFp_vpaes_cbc_encrypt,.-.GFp_vpaes_cbc_encrypt
___
}
{
...
.globl	.GFp_vpaes_set_decrypt_key
.align	4
.GFp_vpaes_set_decrypt_key:
	$STU	$sp,-$FRAME($sp)
	li	r10,`15+6*$SIZE_T`
	li	r11,`31+6*$SIZE_T`
	mflr	r0
	...
	.byte	0,12,0x04,1,0x80,0,3,0
	.long	0
.size	.GFp_vpaes_set_decrypt_key,.-.GFp_vpaes_set_decrypt_key
___
}
