...
# June 2015
#
# Numbers are cycles per processed byte with RingCore_poly1305_blocks alone.
#
#		IALU/gcc-4.9	NEON
#
...
.type	RingCore_poly1305_init_asm,%function
.align	5
RingCore_poly1305_init_asm:
...
#ifdef	__ILP32__
	ldrsw	$t1,.LRingCore_armcap_P
#else
	ldr	$t1,.LRingCore_armcap_P
#endif
	adr	$t0,.LRingCore_armcap_P
	...
	adr	$d0,RingCore_poly1305_blocks
	adr	$r0,poly1305_blocks_neon
	adr	$d1,RingCore_poly1305_emit
...
.type	RingCore_poly1305_blocks,%function
.align	5
...
.type	RingCore_poly1305_emit,%function
.align	5
...
poly1305_blocks_neon:
	...
	cmp	$len,#128
	b.hs	.Lblocks_neon
	cbz	$is_base2_26,RingCore_poly1305_blocks
...
poly1305_emit_neon:
	ldr	$is_base2_26,[$ctx,#24]
	cbz	$is_base2_26,RingCore_poly1305_emit
