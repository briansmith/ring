...
.globl	.GFp_poly1305_init_fpu
.align	6
.GFp_poly1305_init_fpu:
...
.size	.GFp_poly1305_init_fpu,.-.GFp_poly1305_init_fpu

.globl	.GFp_poly1305_blocks_fpu
.align	4
.GFp_poly1305_blocks_fpu:
	srwi.	$len,$len,4
	beq-	Labort
...
.size	.GFp_poly1305_blocks_fpu,.-.GFp_poly1305_blocks_fpu
___
{
...
$code.=<<___;
.globl	.GFp_poly1305_emit_fpu
.align	4
.GFp_poly1305_emit_fpu:
	$STU	$sp,-$FRAME($sp)
	mflr	r0
...
.size	.GFp_poly1305_emit_fpu,.-.GFp_poly1305_emit_fpu
___
}
