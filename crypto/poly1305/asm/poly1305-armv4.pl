...
#if	__ARM_MAX_ARCH__>=7
	ldr	r12,[r11,r12]		@ RingCore_armcap_P
# ifdef	__APPLE__
	ldr	r12,[r12]
# endif
#endif
...
# ifdef	__APPLE__
	...
	adr	r11,RingCore_poly1305_blocks
#  ifdef __thumb2__
	it	ne
#  endif
	movne	r11,r9
	adr	r12,RingCore_poly1305_emit
...
#  ifdef __thumb2__
	itete	eq
#  endif
	addeq	r12,r11,#(RingCore_poly1305_emit-.Lpoly1305_init)
	addne	r12,r11,#(poly1305_emit_neon-.Lpoly1305_init)
	addeq	r11,r11,#(RingCore_poly1305_blocks-.Lpoly1305_init)
...
.LOPENSSL_armcap:
.word	RingCore_armcap_P-.Lpoly1305_init
#endif
___
}	}
$code.=<<___;
