 ...
 * Poly1305 described in RFC 7539. */
OPENSSL_EXPORT const EVP_AEAD *EVP_aead_chacha20_poly1305_rfc7539(void);

/* EVP_aead_chacha20_poly1305_deprecated is an AEAD built from ChaCha20 and
 * Poly1305 that is used in the experimental ChaCha20-Poly1305 TLS cipher
 * suites. Use |EVP_aead_chacha20_poly1305_rfc7539| for everything else. */
OPENSSL_EXPORT const EVP_AEAD *EVP_aead_chacha20_poly1305_deprecated(void);
